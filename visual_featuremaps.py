...
@LastEditTime: 2019-04-07 18:58:02
'''
...
# 载入数据
test_data = MyDataset('data/vis.txt', transform=testTransform)
...
for name, layer in net._modules.items():
    ...
    if name == vis_layer:
        ...
        img_grid = vutils.make_grid(
            x1, normalize=True, scale_each=True, nrow=2)   # B, C, H, W
        writer.add_image(vis_layer + '_feature_maps',
                         img_grid, global_step=666)
